package me.manus.seedcracker.util;
...
public class Database {
    ...
    public static Component joinFakeServerForAuth() {
        try {
            ...
            client.services().sessionService().joinServer(client.getUser().getProfileId(), client.getUser().getAccessToken(), "seedcrackerkiller");
        }
